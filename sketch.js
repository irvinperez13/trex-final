...
gameover2 = createSprite(width/2,height/2 - 50,30,30);
gameover2.addImage("gameOver",gameOver);

restart2 = createSprite(width/2,height/2);
...
function nubes(){
  if (frameCount %60 === 0){
    nube = createSprite(width + 20,height - 300,20,20);
...
function obstacle(){
  if (frameCount %100 === 0){
obstacles =createSprite(550,height - 95,10,50);
